...
import { buttonSection, editModalContainer, subTitle } from './EditBookmarkListModal.css';

interface EditBookmarkListModalProps {
  onClose: () => void;
  id: string | null;
}
export default function EditBookmarkListModalContents({ onClose, id }: EditBookmarkListModalProps) {
